...
export const BasicAllOldWorkSheets = () => {
  ...
  worksheetsModel.push(
    new WorksheetsModel({
      workSheetsId: "BSALLOlD001",
      conditionStr: "ซื้อครบทุกหมวด (เหมา)",
      discount: 450,
